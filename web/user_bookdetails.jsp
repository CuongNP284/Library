...
<html>
    ...
    <body>
        ...
        <div class="info"><h1>Book detail</h1></div>


        <div class="detail">
            <table style="justify-content: center">
                <tr><td>Book ID</td><td>${requestScope.userbook.bookid}</td></tr>
                <tr><td>Book Name</td><td>${requestScope.userbook.bookname}</td></tr>
                <tr><td>Book Author</td><td>${requestScope.userbook.bookauthor}</td></tr>		 
                <tr><td>Book Type</td><td>${requestScope.userbook.booktype}</td></tr>		 
                <tr><td>Book Language</td><td>${requestScope.userbook.booklanguage}</td></tr>		 

            </table>
        </div>

        <div class="cainut">
            <a href="UserBookController"><button>Return to list</button></a>
        </div>
