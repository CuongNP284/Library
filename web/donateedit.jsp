...
<html>
    ...
    <body>
        ...
        <div class="info"><h1>Donate Edit</h1></div>
        ...
        <div class="detail">
            <form action="./DonateController" method="POST">
                <table>
                    ...
                    <tr><td>ID</td><td><input name="id" value="${requestScope.donate.donateid}" required="Please enter" readonly="a"</td></tr>
                    <tr><td>User ID</td><td><input name="userID" value="${requestScope.donate.userid}" required="Please enter" readonly="a"</td></tr>
                    <tr><td>Book Name</td><td><input name="bookName" value="${requestScope.donate.bookname}" required="Please enter" readonly="a"</td></tr>
                    <tr><td>Book Author</td><td><input name="bookAuthor" value="${requestScope.donate.bookauthor}" required="Please enter" readonly="a"</td></tr>
                    <tr><td>Book Language</td><td><input name="bookLanguage" value="${requestScope.donate.booklanguage}" required="Please enter" readonly="a"</td></tr>

                    <tr><td>Created Date</td><td><input name="created_date" value="${requestScope.donate.created_date}" required="Please enter" readonly="a"</td></tr>		 
                    <tr><td>Status</td><td><input name="status" value="${requestScope.donate.status}" required="Please enter" placeholder="True/False"</td></tr>		 
