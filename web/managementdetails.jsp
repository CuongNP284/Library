...
<html>
    ...
    <body>
        ...
        <div class="info"><h1>User Details</h1></div>
        ...
        <div class="detail">
            <table>
                <tr><td>User ID</td><td>${requestScope.user.id}</td></tr>
                <tr><td>User First Name</td><td>${requestScope.user.userfname}</td></tr>
                <tr><td>User Last Name</td><td>${requestScope.user.userlname}</td></tr>		 
                <tr><td>User Email</td><td>${requestScope.user.useremail}</td></tr>		 
                <tr><td>User Contact</td><td>${requestScope.user.usercontact}</td></tr>		 
                <tr><td>Username</td><td>${requestScope.user.username}</td></tr>
                <tr><td>User Password</td><td>${requestScope.user.userpassword}</td></tr>
        ...
        <div class="cainut2">
            <a href="UserController"><button>Return to list</button></a>
        </div>
