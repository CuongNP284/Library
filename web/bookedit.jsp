...
<html>
    ...
    <body>
        ...
        <div class="info"><h1>Book edit form</h1></div>


        <div class="detail">
            <form action="./BookController" method="POST">
                <table>
                    <tr><td>ID</td><td> <input name="id" value="${requestScope.book.bookid}" required="Please enter" readonly="a"</td></tr>
                    <tr><td>Book Name</td><td><input name="bookName" value="${requestScope.book.bookname}" required="Please enter"</td></tr>
                    <tr><td>Book Author</td><td><input name="bookAuthor" value="${requestScope.book.bookauthor}" required="Please enter"</td></tr>		 
                    <tr><td>Book Type</td><td><input name="bookType" value="${requestScope.book.booktype}" required="Please enter"</td></tr>		 
                    <tr><td>Book Language</td><td><input name="bookLanguage" value="${requestScope.book.booklanguage}" required="Please enter"</td></tr>		 
