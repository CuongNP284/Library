...
<html>
    ...
    <body>
        ...
        <div class="info"><h1>Donate Details</h1></div>
        ...
        <div class="cainut">
            <form action="DonateController" style="padding-top: 10px">
                <input type=hidden name="id" value="${requestScope.donate.donateid}">
                <input type=hidden name="action" value="edit">
                <input type=submit value="Edit" ></form>
        </div>

        <div class="cainut2">
            <a href="DonateController"><button>Return to list</button></a>
        </div>
